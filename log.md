# WAR [src/main.c:30:main, 15:58:16, 07-12-2025]
## wayland init [src/wayland.c:60:wayland_init]
## make fd [src/wayland.c:1245:wayland_make_fd]
- xdg_prefix_size: 17
...
- path_len: 24
- addr_len: 26
## END make fd [src/wayland.c:1331:wayland_make_fd]
- written size: 12
...
## reg_bind request [src/wayland.c:1223:wayland_registry_bind]
...
- to id: 3
## END reg_bind request [src/wayland.c:1241:wayland_registry_bind]
...
- xdg_wm_base_ping event ( 12 bytes): 0A 00 00 00 00 00 0C 00 38 0D 00 00
- xdg_wm_base_pong request ( 12 bytes): 0A 00 00 00 03 00 0C 00 38 0D 00 00
...
- xdg_surface_configure event ( 12 bytes): 0B 00 00 00 00 00 0C 00 39 0D 00 00
- xdg_surface_ack_configure request ( 12 bytes): 0B 00 00 00 04 00 0C 00 39 0D 00 00
...
- wl_keyboard_enter event ( 20 bytes): 1F 00 00 00 01 00 14 00 3F 0D 00 00 06 00 00 00 00 00 00 00
- wl_keyboard_modifiers event ( 28 bytes): 1F 00 00 00 04 00 1C 00 40 0D 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
...
- xdg_surface_configure event ( 12 bytes): 0B 00 00 00 00 00 0C 00 3A 0D 00 00
- xdg_surface_ack_configure request ( 12 bytes): 0B 00 00 00 04 00 0C 00 3A 0D 00 00
- wl_surface_attach request ( 20 bytes): 06 00 00 00 01 00 14 00 1D 00 00 00 00 00 00 00 00 00 00 00
- wl_surface_damage request ( 24 bytes): 06 00 00 00 02 00 18 00 00 00 00 00 00 00 00 00 80 07 00 00 38 04 00 00
- wl_surface_commit request (  8 bytes): 06 00 00 00 06 00 08 00
