...
all: $(QUAD_VERT_SHADER_SPV) $(QUAD_FRAG_SHADER_SPV) $(SDF_VERT_SHADER_SPV) $(SDF_FRAG_SHADER_SPV) $(TARGET)
...
$(TARGET): $(UNITY_O) $(QUAD_VERT_SHADER_SPV) $(QUAD_FRAG_SHADER_SPV) $(SDF_FRAG_SHADER_SPV) $(SDF_VERT_SHADER_SPV)
